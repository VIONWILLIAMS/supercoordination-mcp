...
- **MCP 服务器文档**：`/path/to/超协体MVP1.0代码库/README.md`
- **安全指南**：`/path/to/超协体MVP1.0代码库/SECURITY_QUICKSTART.md`
- **权限控制方案**：`/path/to/超协体MVP1.0代码库/权限控制方案.md`
...
**修改建议**：
- 源文件位置：`/path/to/超协体MVP1.0代码库/public/index.html`
